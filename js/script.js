...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Scroll animations using Intersection Observer for better reliability
    const animatedElements = document.querySelectorAll('.about-text, .skills, .project-card, .contact-form, .contact-info');
    ...
    // Initial safeguard: ensure elements are visible if observer fails
    setTimeout(() => {
